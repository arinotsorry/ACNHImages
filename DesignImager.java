...
public class DesignImager {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            File img = new File("/Users/ariwisenburn/Desktop/output/" + fileName);
            ImageIO.write(blockImage, "png", img);
            String[] string = new String[]{"/bin/bash", "-c", ("open /Users/ariwisenburn/Desktop/output" + fileName)};
